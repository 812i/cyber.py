...
if st.session_state.step == 1:
    st.subheader("التحدي 1 من 7: الرسائل النصية للبنوك")
    st.write(
...
# --- السؤال الثاني ---
    ...
    st.subheader("التحدي 2 من 7: الاتصالات الصوتية (Deepfake)")
    st.write(
...
# --- السؤال الرابع ---
    ...
    st.subheader("التحدي 4 من 7: الرسائل الوبرية (Phishing Email)")
    st.write(
